...
public class MainActivity extends AppCompatActivity {
    ...
    private void openWebPage(String webURLStr) {
        Uri parsedURLStr = Uri.parse(webURLStr);

        Intent webIntent = new Intent(Intent.ACTION_VIEW, parsedURLStr);
